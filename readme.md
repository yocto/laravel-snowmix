...
Laravel Mix provides a clean, fluent API for defining basic [Snowpack](http://github.com/snowpackjs/snowpack) build steps for your applications. Mix supports several common CSS and JavaScript pre-processors.
